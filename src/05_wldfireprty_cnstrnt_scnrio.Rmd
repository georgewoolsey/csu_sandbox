...
```{r scenario-maps, fig.height=5, include=F, eval=F}
...
facet_map_fn <- function(row_n=1) {
  plt <- ggplot() +
    ...
    theme(
      ...
      , strip.text.x = element_text(size = 7, vjust = 1)
      , strip.text.y = element_blank()
      , plot.tag.position = c(.5, 0.95)
...
```{r obj-vs-trtbl-plt2, fig.height=9, include=T, eval=T}
# plot
ggplot(
    data = constrained_by_scnro_ls_cnstrnt_temp |> 
        dplyr::filter(cnstrnt_class!="high constraint") |> 
