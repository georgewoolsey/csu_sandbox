...
Timeline of the research utilized to motivate and then support the creation of the WCS:
...
* **2020** - [Evers et al.](https://www.fs.usda.gov/rds/archive/Catalog/RDS-2020-0054) released Fireshed Registry as a geospatial dashboard and decision tool
...
plt_basemap + 
  ...
  scale_fill_manual(values = c("All-Lands"="firebrick","USFS-Only"="orange3","No WCS Status"="gray77")) +
...
ggplot() + 
  ...
  scale_fill_manual(values = viridis::cividis(n=2, direction = -1, alpha = 0.8)) +
  scale_color_manual(values = c("gray44","slategray3", "black")) +
  labs(
...
api_secret <- "AIzaSyBmtsod1swUumFz9AMsR_CC-42DjwkEPcE" #### YOUR API KEY
...
ggplot() + 
    geom_sf(data = 
      ...
      , aes(fill = fireshed_crisis_strategy), lwd = 0.05
    ) +
    geom_sf(
    ...
    scale_fill_manual(values = c("All-Lands"="firebrick","USFS-Only"="orange3")) +
...
```{r obj-vs-trtbl-plt, fig.height=11.5}
# plot
ggplot(
